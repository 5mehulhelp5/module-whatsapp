<?php
/**
 * Standalone install + heartbeat reporter for Panth_WhatsApp.
 *
...
namespace Panth\WhatsApp\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_WhatsApp';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-whatsapp';
